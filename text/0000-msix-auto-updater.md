...
- [Windows Installer](https://learn.microsoft.com/en-us/windows/win32/msi/windows-installer-portal)
  (also known as Microsoft Installer or MSI) is the prevailing Windows.
  Out of the box, MSI does not provide any auto-updating capabilities. MSI installers can be
